...
##### Clone the Repo
    ...
    $ git clone https://github.com/lcenchew/dev-setup.git && cd dev-setup
...
**For more customization, you can [clone](#clone-the-repo) or [fork](https://github.com/lcenchew/dev-setup/fork) the repo and tweak the `.dots` script and its associated components to suit your needs.**
...
#### Running without Git
    ...
    $ curl -O https://raw.githubusercontent.com/lcenchew/dev-setup/custom/.dots && ./.dots [Add ARGS Here]

#### Scripts

* [.dots](https://github.com/lcenchew/dev-setup/blob/custom/.dots)
    * Runs specified scripts
* [bootstrap.sh](https://github.com/lcenchew/dev-setup/blob/custom/bootstrap.sh)
    * Syncs dev-setup to your local home directory `~`
* [osxprep.sh](https://github.com/lcenchew/dev-setup/blob/custom/osxprep.sh)
    * Updates OS X and installs Xcode command line tools
* [brew.sh](https://github.com/lcenchew/dev-setup/blob/custom/brew.sh)
    * Installs common Homebrew formulae and apps
* [osx.sh](https://github.com/lcenchew/dev-setup/blob/custom/osx.sh)
    * Sets up OS X defaults geared towards developers
* [pydata.sh](https://github.com/lcenchew/dev-setup/blob/custom/pydata.sh)
    * Sets up python for data analysis
* [aws.sh](https://github.com/lcenchew/dev-setup/blob/custom/aws.sh)
    * Sets up Spark, Hadoop MapReduce, and Amazon Web Services
* [datastores.sh](https://github.com/lcenchew/dev-setup/blob/custom/datastores.sh)
    * Sets up common data stores
* [web.sh](https://github.com/lcenchew/dev-setup/blob/custom/web.sh)
    * Sets up JavaScript web development
* [android.sh](https://github.com/lcenchew/dev-setup/blob/custom/android.sh)
    * Sets up Android development
...
I encourage you to read through Section 1 so you have a better idea of what each installation script does.  The following discussions describe in greater detail what is executed when running the [.dots](https://github.com/lcenchew/dev-setup/blob/custom/.dots) script.
...
To sync dev-setup to your local home directory without Git, run the following:
    ...
    $ cd ~; curl -#L https://github.com/lcenchew/dev-setup/tarball/custom | tar -xzv --strip-components 1 --exclude={README.md,bootstrap.sh,LICENSE}
...
**Note**: **I strongly encourage you read through the commented [osx.sh source file](https://github.com/lcenchew/dev-setup/blob/custom/osx.sh) and tweak any settings based on your personal preferences.  The script defaults are intended for you to customize.**  For example, if you are not running an SSD you might want to change some of the settings listed in the SSD section.
...
Let's set up some basic configuration. Download the [.gitconfig](https://raw.githubusercontent.com/lcenchew/dev-setup/custom/.gitconfig) file to your home directory:

    $ cd ~
    $ curl -O https://raw.githubusercontent.com/lcenchew/dev-setup/custom/.gitconfig
...
**Note**: On a Mac, it is important to remember to add `.DS_Store` (a hidden OS X system file that's put in folders) to your `.gitignore` files. You can take a look at this repository's [.gitignore](https://github.com/lcenchew/dev-setup/blob/custom/.gitignore) file for inspiration.  Also check out GitHub's [collection of .gitignore templates](https://github.com/github/gitignore).
